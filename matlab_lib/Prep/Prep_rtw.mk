...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Prep.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/oliver/Dropbox/CMU\ courses/ML/project/common/Scripts
ARCH                      = glnxa64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Prep.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/Prep -I/home/oliver/Dropbox/CMU -I$(START_DIR)/courses/ML/project/common/Scripts -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Prep -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/Prep/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/Prep/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
