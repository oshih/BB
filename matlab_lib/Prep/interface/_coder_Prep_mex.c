...
emlrtContext emlrtContextGlobal = { true, false, EMLRT_VERSION_INFO, NULL, "Prep", NULL, false, {2045744189U,2170104910U,2743257031U,4284093946U}, NULL };
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  mexAtExit(Prep_atexit_wrapper);
  /* Dispatch the entry-point. */
  Prep_mexFunction(nlhs, plhs, nrhs, prhs);
}
/* End of code generation (_coder_Prep_mex.c) */
